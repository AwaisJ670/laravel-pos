<template>
    <div class="modal fade" id="userFormModal" tabindex="-1" role="dialog" aria-hidden="true" data-keyboard="false"
        ...
        <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="form-group">
                                    <label class="mb-0">First Name
                                        <span v-if="!$v.form_data.first_name.required">*</span></label>
                                    <input type="text" name="firstName" v-model="form_data.first_name" :class="[
                                        'form-control',
                                        {
                                            'is-invalid-input-no-icon':
                                                !$v.form_data.first_name.required,
                                        },
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="form-group">
                                    <label class="mb-0">Last Name
                                        <span v-if="!$v.form_data.last_name.required">*</span></label>
                                    <input type="text" name="lastName" v-model="form_data.last_name" :class="[
                                        'form-control',
                                        {
                                            'is-invalid-input-no-icon':
                                                !$v.form_data.last_name.required,
                                        },
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="form-group">
                                    <label class="mb-0">Select Role
                                        <span v-if="!$v.form_data.role_id.required">*</span></label>
            ...
            <div v-if="data_loading" class="overlay">
                <i class="spinner-border text-primary spinner-border-sm"></i>
            </div>
        </div>
    </div>
</template>
                ...
                axios({
                    ...
                    .catch((error) => {
                        if (
                            ...
                            // If no specific error, show general status text
                            this.errorToast(error.response.statusText || "An error occurred");
                        }
                    });
            }
        },
